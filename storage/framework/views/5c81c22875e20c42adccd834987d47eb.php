...
<header class="vr-header sticky top-0 left-0 right-0 z-50 bg-white border-b border-brand-black transition-all duration-300">
    <div class="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center space-x-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! auth()->check() || ! auth()->user()->hasRole('restaurant')): ?>
                <a href="<?php echo e(route('restaurants.create')); ?>" class="text-xs font-semibold text-brand-red hover:text-brand-red-hover border border-brand-red hover:bg-brand-red-soft px-4 py-2 rounded-sm transition-all">
                    Devenir partenaire
                </a>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-122845662-0', $__key);
...
?>
                ...
                <a href="<?php echo e(route('space')); ?>" class="border border-brand-black hover:bg-brand-black hover:text-white text-brand-black text-xs px-4 py-2 rounded-sm transition-all">
                    Mon Espace
                </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
<aside id="vrSidebar" class="fixed top-0 right-0 bottom-0 w-80 bg-white border-l border-brand-black z-50 transform translate-x-full transition-transform duration-300 ease-in-out p-6 flex flex-col justify-between">
    ...
    <div class="mt-auto border-t border-border pt-6 space-y-3">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! auth()->check() || ! auth()->user()->hasRole('restaurant')): ?>
            <a href="<?php echo e(route('restaurants.create')); ?>" class="block text-center w-full border border-brand-red text-brand-red py-2.5 rounded-sm font-semibold transition text-sm">
                Devenir partenaire
            </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('space')); ?>" class="block text-center w-full bg-white border border-brand-black text-brand-black py-2.5 rounded-sm font-medium transition text-sm">
                Mon Espace
            </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\omenu-charte\resources\views/components/front/layouts/header.blade.php ENDPATH**/ ?>